...
router.get("/game-management/draw-flags-games", asyncHandler(async (req, res) => { 
    res.render("Admin/AddDrawFlagGame");
}));
...
{  
    ...
    const question = {country: req.body.country, flagDetails: req.body.flagDetails, correctColors: req.body.correctColors, arrangement: req.body.arrangement, flag: flagFileName}; 
    ...
    console.log("Single DrawFlagGame Added Successfully"); 
